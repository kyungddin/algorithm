...
### 메모
1. 그리디보다는 파싱이 빡센 문제였다
2. sstream을 처음으로 써볼 수 있었다
3. getline을 이용하면, python의 split함수를 구현하는 것이 가능해진다
4. stoi()함수는 00009를 9로, 즉 앞의 불필요한 0을 자동으로 제거해준다
